...
class TestFriends < MiniTest::Test
  ...
  def test_likes_to_eat_true
    result = get_food(@person2, "bread")
    assert_equal(true, result)
  end

  def test_likes_to_eat_false
    result = get_food(@person3, "spinach")
  ...
  def test_remove_friend
    result = remove_friend(@person2, "Scrappy-Doo")
  ...
  def test_money_lending_recieving
    result = money_lending_recieving(@person1, @person2, 1)
    assert_equal(3, result)
  end

  def test_money_lending_giving
    result = money_lending_giving(@person1, @person2, 1)
